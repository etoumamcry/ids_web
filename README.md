...
# Autoriser la lecture des logs système (sans sudo)
sudo chmod o+r /var/log/auth.log

# Lancer (mode standard)
python3 app.py

# Lancer avec capture réseau complète (recommandé)
sudo python3 app.py
```
...
| `NetworkCapture` | Paquets IP en temps réel (scapy) | Linux + Windows | root / Admin |
